...
//   },
// });
//hasta aqui bien pero el id es por el telefono
...
export const AddContactScreen = () => {
  ...
  const saveContact = async () => {
    try {
      const id = uuid.v4();
      // console.log(`id desde add: ${id}`)
      // console.log(`Ubicación es: : ${location.latitude}`)
      const contact = { contactId:id, name, telephone, email, role, location:location, photo };
      // console.log(`id del contacto: ${contact.contactId}`)
      // console.log(`name: ${name}`)
      console.log(`FROM ADD contacto.id: ${contact.contactId}`)
